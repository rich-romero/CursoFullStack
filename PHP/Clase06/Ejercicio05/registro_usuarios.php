        ...
        <form id='register' action='registro_usuarios.php' method='post'>
            <fieldset >
                ...
                <div class='container'>
                    ...
                    <input type='number' name='edad' id='edad' value='<?=($_POST["edad"])?>' maxlength="50" /><br/>
                    <span id='register_name_errorloc' class='error'></span>
                </div>
                <div class='container'>
                ...
                <div class='container'>
                    ...
                    <input type='text' name='email' id='email' value='<?=($_POST["email"])?>' maxlength="50" /><br/>
                    <span id='register_email_errorloc' class='error'></span>
                </div>
                <div class='container'>
                    <label for='username' >Nombre de usuario*:</label><br/>
                    <input type='text' name='username' id='username' value='<?=($_POST["username"])?>' maxlength="50" /><br/>
                ...
                <div class='container'>
                    ...
                    <select class="" name="pais" value='<?=($_POST["pais"])?>'>
