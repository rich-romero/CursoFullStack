<?php
  ...
  if($_FILES["imagen"]["error"]=== UPLOAD_ERR_OK){
    ...
    $tipoImg=["jpg","png","bmp","JPEG"];
    if (inarray($ext,$tipoImg)) {
      $miArchivo=dirname(__FILE__)."/"."subidos/$username.$ext";
      //if (file_exists($miArchivo)) {  //echo "El archivo ya existe";  //} else {  //move_uploaded_file($archivoTmp,$miArchivo); //echo "El archvo se subio con exito";  //}
    } else {
